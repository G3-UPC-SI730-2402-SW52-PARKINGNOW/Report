...
| US02 | Visualización de Ciudades con Servicio | WT02 | Implementación de Visualización de Ciudades con Servicio | Como usuario de PARKINGNOW, deseo ver las ciudades en las que el servicio está disponible para saber dónde puedo utilizarlo. | 3 | Javier Aramis Ramos Huamanchumo | Done |
| US03 | Promociones Destacadas | WT03 | Implementación de Promociones Destacadas | Como visitante de PARKINGNOW, deseo ver promociones destacadas en la landing page para aprovechar descuentos en el servicio. | 2 | Diego Ulises Soto Quispe | Done |
...
| US05 | Visualización de la Misión de la Empresa | WT05 | Implementación de Misión de la Empresa | Como visitante de PARKINGNOW, quiero visualizar la misión de la empresa para entender su propósito y valores. | 3 | Diego Ulises Soto Quispe | Done |
| US06 | Visualización de Visión de la Empresa | WT06 | Implementación de Visión de la Empresa | Como visitante de PARKINGNOW, deseo conocer la visión de la empresa para ver sus objetivos a largo plazo. | 3 | Javier Aramis Ramos Huamanchumo | Done |
| US07 | Visualización del Equipo | WT07 | Implementación de Visualización del Equipo | Como visitante de PARKINGNOW, quiero ver quiénes forman parte del equipo detrás de la plataforma para conocer a los responsables del servicio. | 2 | Mateo Italo Loechle Arias | Done |
| US08 | Información de Contacto | WT08 | Implementación de Información de Contacto | Como visitante de PARKINGNOW, deseo tener acceso a la información de contacto para comunicarme en caso de dudas o problemas. | 2 | Rodrigo Liberato | Done |
...
| US10 | Visualización de Información de Características | WT10 | Implementación de Características del Servicio | Como visitante de PARKINGNOW, deseo ver las características principales del servicio en la landing page para entender qué ofrece. | 3 | Samuel Elias | Done |
...
| US12 | Enlaces a Redes Sociales | WT12 | Implementación de Enlaces a Redes Sociales | Como visitante de PARKINGNOW, deseo ver enlaces a las redes sociales de la empresa para seguir sus actualizaciones. | 2 | Rodrigo Liberato | Done |
| US13 | Visualización de Slogan | WT13 | Implementación de Visualización de Slogan | Como visitante de PARKINGNOW, quiero ver el slogan de la empresa en la landing page para captar su mensaje principal. | 3 | Omar Harold | Done |
| US14 | Acceso a Información Legal | WT14 | Implementación de Información Legal | Como visitante de PARKINGNOW, deseo tener acceso a la información legal para conocer los términos y condiciones del servicio. | 2 | Mateo Italo Loechle Arias | Done |
...
| **Asistentes (a la reunión de planificación)** | Todos los miembros del equipo de ParkingNow                                                                      |
| **Resumen de la Revisión del Sprint 3**   | En este sprint, se completaron las funcionalidades principales del backend de ParkingNow, incluyendo la gestión de reservas, notificaciones, consultas, transacciones y usuarios. Se logró un despliegue exitoso dentro del plazo acordado, mejorando la documentación y expandiendo la visión del producto mediante la incorporación de elementos clave.<br><br>En general, el equipo mantuvo una organización y comunicación efectivas, utilizando plataformas como Google Meet para facilitar la coordinación. Sin embargo, se identificó la oportunidad de fortalecer la colaboración y coordinación para alcanzar estándares de calidad aún más altos. |
| **Resumen de la Retrospectiva del Sprint 3** | Para continuar avanzando de manera eficiente, es fundamental optimizar la estimación de tiempo para el desarrollo y la integración del backend con la base de datos. Esto permitirá evitar desajustes en los plazos y asegurar un flujo de trabajo estable.<br><br>También se recomienda un uso más frecuente y organizado del formato Markdown en la documentación y comunicaciones internas, facilitando la comprensión de la información para todo el equipo. |
| **Objetivo del Sprint y Historias de Usuario**    |                                                                                                                      |
| **Velocidad del Sprint 3**             | 20                                                                                                                    |
| **Total de Puntos de Historia**           | 32                                                                                                                   |
