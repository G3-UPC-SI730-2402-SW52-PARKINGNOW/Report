...
|---------------|-----------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|
| US01          | Búsqueda de Estacionamiento              | Como Conductor Urbano Frecuente, quiero buscar espacios de estacionamiento disponibles cerca de mi ubicación para estacionar rápidamente y sin problemas.                         | **Escenario 01:** Búsqueda por ubicación.  
Dado que un conductor busca un espacio para estacionar en una ubicación específica, cuando ingresa la ubicación en el campo de búsqueda, entonces se muestran los espacios disponibles en esa ubicación.  
**Escenario 02:** Filtrado por características.  
Dado que un conductor desea un espacio específico con ciertas características, cuando aplica los filtros en la búsqueda, entonces se muestran solo los espacios que cumplen con esos criterios. | EP01                      |
| US02          | Reserva de Estacionamiento               | Como Conductor Urbano Frecuente, quiero reservar un espacio de estacionamiento antes de llegar a mi destino para asegurarme de que tendré un lugar disponible.                    | **Escenario 01:** Confirmación de reserva.  
Dado que el conductor selecciona un espacio, cuando confirma la reserva, entonces se genera una confirmación de reserva inmediata.  
**Escenario 02:** Modificación de reserva.  
Dado que el conductor desea modificar la reserva, cuando accede a la opción de modificación, entonces la aplicación permite cambios en tiempo real. | EP01                      |
| US03          | Pago por Transacción Segura              | Como Conductor Urbano Frecuente, quiero realizar pagos seguros a través de la aplicación para asegurar la protección de mis datos personales y financieros.                       | **Escenario 01:** Selección de método de pago.  
Dado que el conductor elige un método de pago, cuando realiza el pago, entonces la aplicación muestra un recibo de pago exitoso.  
**Escenario 02:** Error en la transacción.  
Dado que ocurre un error en el pago, cuando el conductor recibe una notificación de fallo, entonces puede intentar de nuevo o seleccionar otro método de pago. | EP03                      |
| US04          | Cancelación de Reserva                   | Como Conductor Urbano Frecuente, quiero poder cancelar una reserva si mis planes cambian, para evitar cargos innecesarios.                                                        | **Escenario 01:** Cancelación antes de tiempo.  
Dado que el conductor tiene una reserva activa, cuando decide cancelarla antes de 30 minutos de la hora de inicio, entonces no se aplican cargos.  
**Escenario 02:** Cancelación tardía.  
Dado que el conductor cancela después de 30 minutos antes de la hora de inicio, cuando decide cancelar, entonces se aplican los cargos correspondientes. | EP01                      |
| US05          | Notificaciones de Disponibilidad         | Como Conductor Urbano Frecuente, quiero recibir notificaciones en tiempo real sobre la disponibilidad de estacionamientos cercanos para tomar decisiones rápidas.                 | **Escenario 01:** Notificación de disponibilidad.  
Dado que hay un espacio disponible, cuando el conductor está cerca, entonces se envía una notificación inmediata de disponibilidad.  
**Escenario 02:** Alerta de ocupación.  
Dado que el espacio se ocupa rápidamente, cuando ya no está disponible, entonces el conductor recibe una actualización de la ocupación. | EP02                      |
| US06          | Gestión de Perfil                        | Como Conductor Urbano Frecuente, quiero actualizar mi información personal y detalles de pago para mantener mis datos seguros y actualizados.                                     | **Escenario 01:** Actualización de información.  
Dado que el conductor desea cambiar sus datos, cuando ingresa al perfil, entonces puede modificar su información personal y detalles de pago.  
**Escenario 02:** Validación de datos.  
Dado que los datos no son válidos, cuando el conductor intenta guardar información incompleta, entonces la aplicación muestra un mensaje de error indicando los campos obligatorios. | EP03                      |
| US07          | Histórico de Estacionamiento             | Como Conductor Urbano Frecuente, quiero acceder a un historial de mis estacionamientos pasados para revisar mis patrones de uso y gastos.                                         | **Escenario 01:** Visualización de historial.  
Dado que el conductor accede a su perfil, cuando selecciona la opción de historial, entonces se muestra un registro de los últimos 6 meses.  
**Escenario 02:** Filtro de historial.  
Dado que el conductor busca detalles específicos, cuando aplica filtros por fecha y ubicación, entonces se muestra el historial correspondiente. | EP01                      |
| US08          | Opiniones de Estacionamiento             | Como Conductor Urbano Frecuente, quiero dejar opiniones sobre los espacios utilizados para mejorar la experiencia de otros usuarios.                                              | **Escenario 01:** Calificación de espacio.  
Dado que el conductor ha utilizado un espacio, cuando finaliza el uso, entonces puede calificar el espacio y dejar una opinión.  
**Escenario 02:** Recompensa por opinión.  
Dado que el conductor deja una opinión detallada, cuando se registra la opinión, entonces recibe puntos de fidelidad. | EP06                      |
| US09          | Preferencias de Notificación             | Como Conductor Urbano Frecuente, quiero configurar mis preferencias de notificación para recibir solo alertas relevantes.                                                          | **Escenario 01:** Personalización de alertas.  
Dado que el conductor quiere personalizar alertas, cuando accede a la configuración de notificaciones, entonces puede seleccionar los tipos de notificación que desea recibir.  
**Escenario 02:** Confirmación de preferencias.  
Dado que el conductor guarda sus preferencias, cuando confirma los cambios, entonces la aplicación actualiza las notificaciones según lo solicitado. | EP02                      |
| US10          | Integración con Calendario               | Como Conductor Urbano Frecuente, quiero que la aplicación sincronice mis reservas con mi calendario personal para organizar mejor mi tiempo.                                       | **Escenario 01:** Sincronización de reservas.  
Dado que el conductor ha vinculado su calendario, cuando hace una nueva reserva, entonces se agrega automáticamente a su calendario personal.  
**Escenario 02:** Conflicto de eventos.  
Dado que hay un conflicto con otra reserva, cuando la aplicación detecta el conflicto, entonces muestra una alerta para resolverlo. | EP01                      |
| US11          | Soporte y Ayuda en la Aplicación         | Como Conductor Urbano Frecuente, quiero acceder a una sección de soporte dentro de la aplicación para resolver dudas y problemas rápidamente.                                      | **Escenario 01:** Acceso a soporte.  
Dado que el conductor tiene una pregunta, cuando accede a la sección de ayuda, entonces puede utilizar el chat en vivo o leer las FAQs.  
**Escenario 02:** Solicitud de asistencia.  
Dado que el conductor no encuentra solución en las FAQs, cuando solicita asistencia, entonces se conecta con el soporte técnico. | EP03                      |
| US12          | Confirmación de Entrada y Salida         | Como Dueño de Playa de Estacionamiento, quiero recibir confirmación al ingresar y salir un vehículo de un espacio para asegurarme de que las reservas se gestionen correctamente.  | **Escenario 01:** Confirmación de entrada.  
Dado que un vehículo ingresa a un espacio reservado, cuando el sensor infrarrojo detecta el ingreso, entonces se envía una notificación de entrada.  
**Escenario 02:** Confirmación de salida.  
Dado que un vehículo sale del espacio reservado, cuando el sensor detecta la salida, entonces se envía una notificación de salida. | EP05                      |
| US13          | Acceso para Usuarios con Discapacidad    | Como Conductor Urbano Frecuente, quiero asegurarme de que los espacios accesibles estén claramente marcados y disponibles para reservar en la aplicación.                         | **Escenario 01:** Marcado de espacios accesibles.  
Dado que hay espacios accesibles disponibles, cuando el conductor realiza una búsqueda, entonces se resaltan los espacios accesibles en la lista de resultados.  
**Escenario 02:** Disponibilidad actualizada.  
Dado que un espacio accesible se reserva, cuando se confirma la reserva, entonces se actualiza la disponibilidad inmediatamente. | EP05                      |
| US14          | Pago por Transacción de Estacionamiento  | Como Dueño de Playa de Estacionamiento, quiero asegurarme de que los pagos por el uso de espacios se realicen de manera segura y transparente.                                     | **Escenario 01:** Confirmación de pago.  
Dado que el dueño de la playa selecciona la opción de revisar pagos, cuando accede al historial de transacciones, entonces puede ver los pagos completados.  
**Escenario 02:** Resolución de disputas.  
Dado que ocurre una disputa de pago, cuando el dueño revisa el historial, entonces puede contactar al soporte para resolver la disputa. | EP03                      |
| US15          | Actualización Automática de Rutas       | Como Dueño de Playa de Estacionamiento, quiero que la aplicación actualice automáticamente las rutas para optimizar la llegada de los conductores a los espacios disponibles.     | **Escenario 01:** Ajuste de rutas.  
Dado que hay cambios en la disponibilidad de espacio, cuando la aplicación detecta una ruta más eficiente, entonces sugiere la nueva ruta a los conductores.  
**Escenario 02:** Optimización en tiempo real.  
Dado que el tráfico cambia rápidamente, cuando se detecta un atasco, entonces la aplicación actualiza las rutas para evitar retrasos. | EP04                      |
| US16          | Modo de Seguridad Nocturna              | Como Dueño de Playa de Estacionamiento, quiero activar un modo de seguridad nocturna para recibir alertas adicionales y monitoreo durante la noche.                                | **Escenario 01:** Activación de modo nocturno.  
Dado que se activa el modo nocturno, cuando se detecta movimiento sospechoso cerca de los vehículos, entonces se envía una alerta de seguridad.  
**Escenario 02:** Verificación de identidad.  
Dado que el modo nocturno está activo, cuando un vehículo llega durante la noche, entonces se solicita una confirmación de identidad del conductor. | EP05                      |
| US17          | Feedback Post-Estacionamiento           | Como Dueño de Playa de Estacionamiento, quiero recibir feedback después de cada uso del estacionamiento para mejorar la calidad del servicio.                                      | **Escenario 01:** Solicitud de feedback.  
Dado que un conductor completa una reserva, cuando sale del espacio, entonces se solicita una breve encuesta de satisfacción.  
**Escenario 02:** Análisis de feedback.  
Dado que se recibe feedback negativo, cuando el dueño revisa los comentarios, entonces puede tomar medidas para mejorar el servicio. | EP06                      |
| US18          | Alertas de Seguridad y Emergencia       | Como Dueño de Playa de Estacionamiento, quiero recibir alertas de seguridad y emergencia en la aplicación para responder rápidamente a situaciones peligrosas.                    | **Escenario 01:** Detección de emergencia.  
Dado que se detecta un problema de seguridad, cuando un vehículo está en peligro, entonces se envía una alerta de emergencia al dueño.  
**Escenario 02:** Botón de pánico.  
Dado que el conductor presiona el botón de emergencia, cuando se activa, entonces se conecta con el soporte de seguridad de inmediato. | EP05                      |
| US19          | Revisión de Espacios Recomendados       | Como Conductor Urbano Frecuente, quiero ver recomendaciones basadas en mis patrones de uso para elegir los mejores espacios de estacionamiento.                                    | **Escenario 01:** Recomendaciones personalizadas.  
Dado que el conductor ha usado frecuentemente ciertos espacios, cuando abre la aplicación, entonces se muestran recomendaciones basadas en sus preferencias.  
**Escenario 02:** Feedback sobre recomendaciones.  
Dado que el conductor sigue una recomendación, cuando reserva un espacio sugerido, entonces se solicita feedback sobre la recomendación. | EP06                      |
| US20          | Integración con Servicios de Terceros   | Como Conductor Urbano Frecuente, quiero que la aplicación se integre con servicios de terceros, como mapas o asistentes de voz, para mejorar mi experiencia de uso.                | **Escenario 01:** Uso de asistentes de voz.  
Dado que el conductor utiliza un asistente de voz, cuando solicita información sobre estacionamientos, entonces el asistente proporciona detalles en tiempo real.  
**Escenario 02:** Sincronización con servicios de mapas.  
Dado que el conductor usa servicios de mapas, cuando selecciona una ruta, entonces se sincroniza automáticamente con PARKINGNOW. | EP04                      |
