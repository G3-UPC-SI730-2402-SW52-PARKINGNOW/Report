...
|---------------|-----------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|
| US01          | Búsqueda de Estacionamiento              | Como Conductor Urbano Frecuente, quiero buscar espacios de estacionamiento disponibles cerca de mi ubicación para estacionar rápidamente y sin problemas.                         | **Escenario 01: Búsqueda por proximidad**<br>**Dado que** el conductor ha ingresado a la aplicación, **cuando** busca estacionamientos cerca de su ubicación, **entonces** se muestran los espacios disponibles dentro de un radio de 1 km.<br><br>**Escenario 02: Notificación de cambio de disponibilidad**<br>**Dado que** los datos se actualizan automáticamente, **cuando** hay un cambio en la disponibilidad, **entonces** el usuario es notificado en tiempo real. | EP01                      |
| US02          | Reserva de Estacionamiento               | Como Conductor Urbano Frecuente, quiero reservar un espacio de estacionamiento antes de llegar a mi destino para asegurarme de que tendré un lugar disponible.                    | **Escenario 01: Confirmación de reserva**<br>**Dado que** el usuario ha seleccionado un espacio, **cuando** confirma la reserva, **entonces** se genera una confirmación de reserva al instante.<br><br>**Escenario 02: Modificación de reserva**<br>**Dado que** la reserva puede ser modificada, **cuando** el usuario quiere cambiar la hora o ubicación, **entonces** la aplicación permite la modificación en tiempo real. | EP01                      |
| US03          | Pago por Transacción Segura              | Como Conductor Urbano Frecuente, quiero realizar pagos seguros por cada transacción a través de la aplicación para evitar el uso de efectivo y asegurar la protección de mis datos. | **Escenario 01: Confirmación de pago**<br>**Dado que** el usuario selecciona el método de pago, **cuando** realiza el pago, **entonces** la aplicación muestra una notificación de recibo exitoso.<br><br>**Escenario 02: Gestión de errores de pago**<br>**Dado que** puede haber errores en la transacción, **cuando** hay una falla en el pago, **entonces** se muestra una alerta de error con opciones para intentar de nuevo o cambiar el método de pago. | EP03                      |
| US04          | Cancelación de Reserva                   | Como Conductor Urbano Frecuente, quiero poder cancelar una reserva de estacionamiento si mis planes cambian para evitar cargos innecesarios.                                      | **Escenario 01: Cancelación sin cargo**<br>**Dado que** el usuario tiene una reserva activa, **cuando** decide cancelarla antes de 30 minutos de la hora de inicio, **entonces** no se aplican cargos.<br><br>**Escenario 02: Cancelación con penalización**<br>**Dado que** hay políticas de cancelación, **cuando** el usuario cancela después de 30 minutos, **entonces** se aplican cargos correspondientes. | EP01                      |
| US05          | Notificaciones de Disponibilidad         | Como Conductor Urbano Frecuente, quiero recibir notificaciones en tiempo real sobre la disponibilidad de estacionamientos cercanos para elegir la mejor opción rápidamente.       | **Escenario 01: Notificación de disponibilidad**<br>**Dado que** el usuario está cerca de una zona con estacionamientos, **cuando** un espacio se desocupa, **entonces** se envía una notificación de disponibilidad.<br><br>**Escenario 02: Actualización de estado**<br>**Dado que** los espacios pueden ocuparse rápidamente, **cuando** un espacio disponible es tomado, **entonces** el usuario recibe una alerta de actualización de disponibilidad. | EP02                      |
| US06          | Gestión de Perfil                        | Como Conductor Urbano Frecuente, quiero actualizar mi información de perfil y detalles de pago en la aplicación para mantener mis datos actualizados y seguros.                  | **Escenario 01: Actualización de perfil**<br>**Dado que** el usuario quiere actualizar sus datos, **cuando** ingresa al perfil, **entonces** puede modificar su información personal y detalles de pago.<br><br>**Escenario 02: Validación de datos**<br>**Dado que** los datos deben ser precisos, **cuando** se intenta guardar información incompleta, **entonces** la aplicación muestra un mensaje de error solicitando los campos obligatorios. | EP03                      |
| US07          | Histórico de Estacionamiento             | Como Conductor Urbano Frecuente, quiero acceder a un historial de mis estacionamientos pasados para revisar mis patrones de uso y gastos.                                         | **Escenario 01: Visualización de historial**<br>**Dado que** el usuario accede a su perfil, **cuando** selecciona el historial de uso, **entonces** se muestra un registro de los últimos 6 meses.<br><br>**Escenario 02: Filtro de historial**<br>**Dado que** el usuario quiere revisar detalles específicos, **cuando** filtra por fechas y ubicaciones, **entonces** se muestra el historial correspondiente. | EP01                      |
| US08          | Opiniones de Estacionamiento             | Como Dueño de Playa de Estacionamiento, quiero dejar opiniones y calificaciones sobre los espacios de estacionamiento utilizados para ayudar a mejorar el servicio.                | **Escenario 01: Registro de opiniones**<br>**Dado que** el usuario ha completado un estacionamiento, **cuando** califica el espacio, **entonces** se registra la opinión en la base de datos.<br><br>**Escenario 02: Recompensas por opiniones**<br>**Dado que** se ofrecen recompensas, **cuando** el usuario deja una opinión detallada, **entonces** recibe puntos de fidelidad. | EP06                      |
| US09          | Preferencias de Notificación             | Como Dueño de Playa de Estacionamiento, quiero configurar mis preferencias de notificación para recibir solo alertas importantes relacionadas con mis reservas y estacionamientos. | **Escenario 01: Configuración de alertas**<br>**Dado que** el usuario quiere personalizar alertas, **cuando** accede a la configuración, **entonces** puede seleccionar los tipos de notificación.<br><br>**Escenario 02: Confirmación de preferencias**<br>**Dado que** las preferencias afectan la experiencia, **cuando** el usuario guarda sus opciones, **entonces** la aplicación confirma las preferencias actualizadas. | EP02                      |
| US10          | Integración con Calendario               | Como Dueño de Playa de Estacionamiento, quiero que la aplicación sincronice mis reservas con mi calendario personal para gestionar mejor mi tiempo y compromisos.                 | **Escenario 01: Sincronización automática**<br>**Dado que** el usuario ha vinculado su calendario, **cuando** hace una nueva reserva, **entonces** se agrega automáticamente a su calendario.<br><br>**Escenario 02: Alerta de conflicto de eventos**<br>**Dado que** hay un conflicto de eventos, **cuando** la reserva coincide con otro evento, **entonces** la aplicación muestra una alerta. | EP01                      |
| US11          | Soporte y Ayuda en la Aplicación         | Como Dueño de Playa de Estacionamiento, quiero acceder a una sección de soporte dentro de la aplicación para resolver dudas y problemas rápidamente.                             | **Escenario 01: Acceso a FAQs y soporte**<br>**Dado que** el usuario tiene una duda, **cuando** accede a la sección de ayuda, **entonces** puede utilizar el chat en vivo o leer las FAQs.<br><br>**Escenario 02: Solicitud de asistencia técnica**<br>**Dado que** el usuario necesita más asistencia, **cuando** no encuentra solución en las FAQs, **entonces** puede solicitar asistencia técnica directa. | EP03                      |
| US12          | Confirmación de Entrada y Salida         | Como Conductor Urbano Frecuente, quiero recibir confirmación al ingresar y salir de un estacionamiento para asegurarme de que mi reserva se ha gestionado correctamente.         | **Escenario 01: Confirmación de entrada**<br>**Dado que** el usuario ingresa a un estacionamiento reservado, **cuando** el sensor infrarrojo detecta el vehículo, **entonces** se envía una notificación de entrada.<br><br>**Escenario 02: Confirmación de salida**<br>**Dado que** el usuario sale del estacionamiento, **cuando** el sensor detecta la salida, **entonces** se envía una notificación de salida. | EP05                      |
| US13          | Acceso para Usuarios con Discapacidad    | Como Dueño de Playa de Estacionamiento, quiero asegurarme de que los espacios accesibles estén claramente marcados y disponibles para reservar en la aplicación.                  | **Escenario 01: Marcado de espacios accesibles**<br>**Dado que** hay espacios accesibles disponibles, **cuando** el usuario realiza una búsqueda, **entonces** se resaltan los espacios accesibles en la lista.<br><br>**Escenario 02: Actualización de disponibilidad**<br>**Dado que** la accesibilidad es prioritaria, **cuando** un espacio accesible se reserva, **entonces** se actualiza la disponibilidad inmediatamente. | EP05                      |
| US14          | Pago por Transacción de Estacionamiento  | Como Dueño de Playa de Estacionamiento, quiero realizar pagos por transacción de manera segura a través de la aplicación para cada reserva de estacionamiento.                   | **Escenario 01: Proceso de pago**<br>**Dado que** el usuario selecciona un espacio de estacionamiento, **cuando** procede al pago, **entonces** se genera un recibo de pago detallado.<br><br>**Escenario 02: Opción de métodos de pago**<br>**Dado que** hay múltiples métodos de pago, **cuando** el usuario elige uno, **entonces** el sistema procesa el pago y envía una confirmación. | EP03                      |
| US15          | Actualización Automática de Rutas       | Como Conductor Urbano Frecuente, quiero que la aplicación actualice automáticamente las rutas hacia el estacionamiento más cercano en caso de cambios de tráfico para reducir el tiempo de viaje. | **Escenario 01: Ajuste de ruta**<br>**Dado que** hay un cambio en el tráfico, **cuando** el usuario está en ruta, **entonces** la aplicación ajusta la ruta para optimizar el tiempo de llegada.<br><br>**Escenario 02: Notificación de ruta más rápida**<br>**Dado que** el tráfico puede variar, **cuando** la aplicación detecta una ruta más rápida, **entonces** notifica al usuario para cambiar de ruta. | EP04                      |
| US16          | Modo de Seguridad Nocturna              | Como Conductor Urbano Frecuente, quiero activar un modo de seguridad nocturna para recibir alertas adicionales y monitoreo durante la noche.                                     | **Escenario 01: Alerta de seguridad nocturna**<br>**Dado que** el usuario activa el modo nocturno, **cuando** se detecta movimiento sospechoso cerca del vehículo, **entonces** se envía una alerta inmediata.<br><br>**Escenario 02: Confirmación de identidad**<br>**Dado que** el modo nocturno está activado, **cuando** el usuario llega a su vehículo, **entonces** se solicita una confirmación de identidad. | EP05                      |
| US17          | Feedback Post-Estacionamiento           | Como Conductor Urbano Frecuente, quiero proporcionar feedback después de cada uso de estacionamiento para ayudar a mejorar la calidad del servicio.                               | **Escenario 01: Solicitud de feedback**<br>**Dado que** el usuario completa una reserva, **cuando** sale del estacionamiento, **entonces** se solicita una breve encuesta de satisfacción.<br><br>**Escenario 02: Detalle de problemas específicos**<br>**Dado que** el usuario califica el servicio, **cuando** la calificación es baja, **entonces** se ofrece la opción de detallar problemas específicos. | EP06                      |
| US18          | Alertas de Seguridad y Emergencia       | Como Dueño de Playa de Estacionamiento, quiero recibir alertas de seguridad y emergencia en la aplicación para actuar rápidamente en caso de situaciones peligrosas.            | **Escenario 01: Alerta de emergencia**<br>**Dado que** el sistema detecta un problema de seguridad, **cuando** el usuario está dentro del estacionamiento, **entonces** se envía una alerta de emergencia.<br><br>**Escenario 02: Conexión con soporte de seguridad**<br>**Dado que** el usuario necesita asistencia, **cuando** presiona el botón de emergencia, **entonces** se conecta con el soporte de seguridad. | EP05                      |
| US19          | Revisión de Espacios Recomendados       | Como Dueño de Playa de Estacionamiento, quiero ver recomendaciones basadas en mis patrones de uso para elegir los mejores espacios de estacionamiento.                           | **Escenario 01: Recomendaciones personalizadas**<br>**Dado que** el usuario ha usado frecuentemente ciertos espacios, **cuando** abre la aplicación, **entonces** se muestran recomendaciones personalizadas.<br><br>**Escenario 02: Confirmación rápida de reserva**<br>**Dado que** el usuario sigue las recomendaciones, **cuando** reserva un espacio sugerido, **entonces** recibe una notificación de confirmación rápida. | EP06                      |
| US20          | Integración con Servicios de Terceros   | Como Dueño de Playa de Estacionamiento, quiero que la aplicación se integre con servicios de terceros, como mapas o asistentes de voz, para mejorar mi experiencia de uso.       | **Escenario 01: Uso de asistentes de voz**<br>**Dado que** el usuario tiene un asistente de voz compatible, **cuando** solicita información sobre estacionamientos, **entonces** el asistente proporciona detalles en tiempo real.<br><br>**Escenario 02: Sincronización con mapas**<br>**Dado que** el usuario utiliza servicios de mapas, **cuando** selecciona una ruta, **entonces** se sincroniza automáticamente con PARKINGNOW. | EP04                      |
