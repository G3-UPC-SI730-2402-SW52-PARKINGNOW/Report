...
| TP1      | 26/09/2024 | Loechle Arias Mateo Italo`<br><br>`Rodrigo Liberato Saldaña`<br><br>`Samuel Elias Molina Asencios`<br><br>`Omar Harold Rivera Ticllacuri`<br><br>`Diego Ulises Soto Quispe`<br><br>`Ramos Huamanchumo, Javier Aramis | Se agregó el contenido del capítulo 5, apartados 5.2.2, 5.2.2.1, 5.2.2.2, 5.2.2.3, 5.2.2.4, 5.2.2.5, 5.2.2.6, 5.2.2.7, 5.2.2.8                                                                                                                                                                                                       |
| TB2      | 03/11/2024 | Loechle Arias Mateo Italo`<br><br>`Rodrigo Liberato Saldaña`<br><br>`Samuel Elias Molina Asencios`<br><br>`Omar Harold Rivera Ticllacuri`<br><br>`Diego Ulises Soto Quispe`<br><br>`Ramos Huamanchumo, Javier Aramis | Se agregó el contenido del capítulo 5, apartados 5.2.3, 5.2.3.1, 5.2.3.2, 5.2.3.3, 5.2.3.4, 5.2.3.5, 5.2.3.6, 5.2.3.7, 5.2.3.8, 5.3, 5.3.1, 5.3.2, 5.3.3, 5.4 y las conclusiones.                                                                                                                                                    |
| TF1      | 21/11/2024 | Loechle Arias Mateo Italo`<br><br>`Rodrigo Liberato Saldaña`<br><br>`Samuel Elias Molina Asencios`<br><br>`Omar Harold Rivera Ticllacuri`<br><br>`Diego Ulises Soto Quispe`<br><br>`Ramos Huamanchumo, Javier Aramis | Se agregó el contenido del capítulo 5, apartados 5.2.4, 5.2.4.1, 5.2.4.2, 5.2.4.3, 5.2.4.4, 5.2.4.5, 5.2.4.6, 5.2.4.7, 5.2.4.8 y al capítulo de Conclusiones.                                                                                                                                                                       |
...
TP1 :Durante la preparación del informe, se realizaron las siguientes tareas.
...
1. **UXPressia**: [https://uxpressia.com/](https://uxpressia.com/)Herramienta empleada para desarrollar User Personas, Empathy Maps, Journey Maps e Impact Maps, brindando un enfoque centrado en el usuario.
2. **Figma**: [https://www.figma.com/](https://www.figma.com/)Plataforma colaborativa de diseño usada para la creación de wireframes, maquetas y prototipos para aplicaciones móviles y de escritorio.
...
4. **Visual Studio Code**: [https://code.visualstudio.com/](https://code.visualstudio.com/)Editor de código ligero utilizado para crear la landing page y aplicaciones web, haciendo uso de HTML5, CSS3, JavaScript y TypeScript.
5. **WebStorm**:Entorno de desarrollo utilizado para trabajar con HTML, CSS, JavaScript y frameworks como Vue y Angular.
6. **Rider**:IDE utilizado para desarrollar con el lenguaje C# y la plataforma .NET, implementando servicios web basados en ASP.NET.
7. **Spring Boot Framework**:Framework utilizado para crear servicios web RESTful en Java, brindando una base sólida y escalable.
8. **GitHub**: [https://github.com/](https://github.com/)Plataforma usada para el control de versiones, aplicando GitFlow para una gestión estructurada del código.
...
10. **WhatsApp**: [https://web.whatsapp.com/](https://web.whatsapp.com/)Aplicación de mensajería utilizada para coordinar y discutir temas del proyecto en tiempo real.
...
12. **Vertabelo**: [https://vertabelo.com/](https://vertabelo.com/)Herramienta en línea utilizada para diseñar y gestionar de forma colaborativa las bases de datos del proyecto.
13. **LucidChart**: [https://lucid.app/](https://lucid.app/)Plataforma usada para crear diagramas UML, wireflows y user flows, facilitando la planificación y visualización del sistema.
...
15. **Swagger / OpenAPI Specification**: [https://swagger.io/specification/](https://swagger.io/specification/)Utilizado para documentar y probar las APIs RESTful creadas con Spring Boot, permitiendo la generación de documentación interactiva.
16. **Markdown**
...
|              Attendees              |                                                                                                                                                                                                                                                       - Diego Ulises Soto Quispe<br> - Javier Aramis, Ramos Huamanchumo <br> - Mateo Italo, Loechle Arias<br>- Rodrigo Liberato Saldaña<br> - Omar Harold Rivera Ticllacuri<br> - Samuel Elias Molina Asencios                                                                                                                                                                                                                                                       |
...
Trello: ![alt text](Assets/Trello.png)
...
|        US01        |      Navegación Intuitiva en la Landing Page      |           WT01           |          Implementación de Navegación Intuitiva          | Como visitante de la plataforma PARKINGNOW, deseo que la landing page tenga una barra de navegación clara para encontrar fácilmente las funciones clave. |          5          |          Samuel Elias          |  Done  |
|        US02        |      Visualización de Ciudades con Servicio      |           WT02           | Implementación de Visualización de Ciudades con Servicio |               Como usuario de PARKINGNOW, deseo ver las ciudades en las que el servicio está disponible para saber dónde puedo utilizarlo.               |          4          | Javier Aramis Ramos Huamanchumo |  Done  |
|        US03        |               Promociones Destacadas               |           WT03           |         Implementación de Promociones Destacadas         |                Como visitante de PARKINGNOW, deseo ver promociones destacadas en la landing page para aprovechar descuentos en el servicio.                |          6          |    Diego Ulises Soto Quispe    |  Done  |
|        US04        |  Beneficios para Conductores y Dueños de Playas  |           WT04           |               Implementación de Beneficios               |           Como visitante de PARKINGNOW, quiero conocer los beneficios del servicio tanto para conductores como para dueños de estacionamientos.           |          5          |        Rodrigo Liberato        |  Done  |
|        US05        |     Visualización de la Misión de la Empresa     |           WT05           |          Implementación de Misión de la Empresa          |                      Como visitante de PARKINGNOW, quiero visualizar la misión de la empresa para entender su propósito y valores.                      |          5          |    Diego Ulises Soto Quispe    |  Done  |
|        US06        |      Visualización de Visión de la Empresa      |           WT06           |          Implementación de Visión de la Empresa          |                         Como visitante de PARKINGNOW, deseo conocer la visión de la empresa para ver sus objetivos a largo plazo.                         |          4          | Javier Aramis Ramos Huamanchumo |  Done  |
|        US07        |             Visualización del Equipo             |           WT07           |        Implementación de Visualización del Equipo        |      Como visitante de PARKINGNOW, quiero ver quiénes forman parte del equipo detrás de la plataforma para conocer a los responsables del servicio.      |          4          |    Mateo Italo Loechle Arias    |  Done  |
|        US08        |              Información de Contacto              |           WT08           |        Implementación de Información de Contacto        |               Como visitante de PARKINGNOW, deseo tener acceso a la información de contacto para comunicarme en caso de dudas o problemas.               |          4          |        Rodrigo Liberato        |  Done  |
|        US09        |           Envío de Mensaje de Contacto           |           WT09           |      Implementación de Envío de Mensaje de Contacto      |      Como visitante de PARKINGNOW, quiero poder enviar mensajes de contacto directamente desde la plataforma para resolver inquietudes rápidamente.      |          5          |           Omar Harold           |  Done  |
|        US10        | Visualización de Información de Características |           WT10           |      Implementación de Características del Servicio      |            Como visitante de PARKINGNOW, deseo ver las características principales del servicio en la landing page para entender qué ofrece.            |          6          |          Samuel Elias          |  Done  |
|        US11        |       Botón de Registro e Inicio de Sesión       |           WT11           | Implementación de Botón de Registro e Inicio de Sesión |       Como visitante de PARKINGNOW, quiero tener un botón de registro e inicio de sesión en la landing page para acceder fácilmente a mi cuenta.       |          5          | Javier Aramis Ramos Huamanchumo |  Done  |
|        US12        |              Enlaces a Redes Sociales              |           WT12           |        Implementación de Enlaces a Redes Sociales        |                    Como visitante de PARKINGNOW, deseo ver enlaces a las redes sociales de la empresa para seguir sus actualizaciones.                    |          5          |        Rodrigo Liberato        |  Done  |
|        US13        |              Visualización de Slogan              |           WT13           |        Implementación de Visualización de Slogan        |                   Como visitante de PARKINGNOW, quiero ver el slogan de la empresa en la landing page para captar su mensaje principal.                   |          6          |           Omar Harold           |  Done  |
|        US14        |            Acceso a Información Legal            |           WT14           |           Implementación de Información Legal           |              Como visitante de PARKINGNOW, deseo tener acceso a la información legal para conocer los términos y condiciones del servicio.              |          8          |    Mateo Italo Loechle Arias    |  Done  |
...
| :------------------------------------------------------------------: | :----------: | :-----------: | :----------------: | :---------------------------: | :--------------: |
| https://github.com/G3-UPC-SI730-2402-SW52-PARKINGNOW/Landing-Page-g3 | Feature/main |    d033f50    |   Initial commit   |              \-              | 3 semanas atrás |
...
Esta sección describe los elementos clave de la planificación y ejecución del Sprint 3. Durante este sprint, el enfoque principal estará en reforzar el backend de **ParkingNow**, implementando funcionalidades esenciales para garantizar una experiencia de usuario fluida y confiable en la plataforma.

## 5.2.3.1. Planificación del Sprint 3

A continuación, se detallan los aspectos de la reunión de planificación del Sprint, donde se definieron las tareas a realizar durante el período establecido.
|               Sprint #               |                                                                                                                                                                                                                                                                                                                                             Sprint 3                                                                                                                                                                                                                                                                                                                                             |
| :----------------------------------: | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
| **Sprint Planning Background** |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
|                 Date                 |                                                                                                                                                                                                                                                                                                                                             29/10/24                                                                                                                                                                                                                                                                                                                                             |
...
|    US43    |   Auditoría de Acciones en la Plataforma   |       WT03       |   Implementación de Auditorías de Acciones en la Plataforma   | Desarrollar la funcionalidad de auditorías para las acciones dentro de la plataforma. |         5         |  Javier  Aramis  |  Done  |
...
|    US50    |       Auditoría de Cambios de Tarifas       |       WT09       |       Implementación de Auditoría de Cambios de Tarifas       |      Desarrollar la funcionalidad de auditorías para los cambios en las tarifas.      |         5         |   Mateo Italo   |  Done  |
...
![alt text](<Assets/commit grafico .png>)
...
![alt text](<Assets/frontend commit .png>)

![alt text](<Assets/frontend grafico .png>)
...
![alt text](<Assets/landing commit .png>)
...
![alt text](<Assets/landing grafico.png>)
...
| Entrevistas completo                                         | https://upcedupe-my.sharepoint.com/:v:/g/personal/u202214477_upc_edu_pe/EeDCZvHEKARNvBHUb8r47O0BKJRBFRJHk6zb0zyJLDGMkw?e=z0c40z&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D |
| About the Team                                               | https://upcedupe-my.sharepoint.com/:v:/g/personal/u202214477_upc_edu_pe/EbtTG954tUpNu6Wn6-1A0KYBRa-ZrkprjOxOS6Ue2Nfk_Q?e=4J9LwO&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D|
| Video About the Product                                      | https://upcedupe-my.sharepoint.com/:v:/g/personal/u202214477_upc_edu_pe/ETy_AwX8JtRLky8U-PG0qFYBGOOVXuTthxFLdBOFv1Q1GA?e=xh5QDn&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D|
| Video de Exposición TB2                                     | https://upcedupe-my.sharepoint.com/:v:/g/personal/u202214477_upc_edu_pe/EXa9qZCZ3vZFvQ65XKo7w_UBug-jsB_8WyO1CY5GI4g0Jw?e=e0vOLU&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D |
...
| Link del Trello - Sprint 4                                         | https://trello.com/invite/b/673953990a59e2fefde29dcc/ATTIa8ef609c281a616bb14119d7d5c76fb0E2DB36AC/sprint-backlog-4                                                                                                                                                                                                                                                             |