...
|---------------|--------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------|---------------------------|
| US01          | Buscar Estacionamiento Disponible    | Como usuario, quiero buscar estacionamientos disponibles cerca de mi ubicación actual para ahorrar tiempo en la búsqueda.                                          | Escenario 1: Búsqueda por geolocalización muestra resultados actualizados.                                                                                            | EP01                      |
| US02          | Reservar Espacio de Estacionamiento  | Como usuario, quiero reservar un espacio de estacionamiento con anticipación para garantizar un lugar al llegar a mi destino.                                      | Escenario 1: Confirmación de reserva con detalles enviados al usuario.                                                                                                | EP01                      |
| US03          | Cancelar Reserva                     | Como usuario, quiero cancelar una reserva si mis planes cambian para evitar cargos innecesarios.                                                                   | Escenario 1: Reserva cancelada dentro del plazo permitido sin penalización.                                                                                           | EP01                      |
| US04          | Recibir Notificaciones de Reserva    | Como usuario, quiero recibir notificaciones en tiempo real sobre cambios en mi reserva para estar informado sobre la disponibilidad del espacio.                   | Escenario 1: Notificación automática enviada al usuario al modificar la reserva.                                                                                      | EP02                      |
| US05          | Ver Historial de Reservas            | Como usuario, quiero ver el historial de mis reservas para gestionar y revisar mis actividades de estacionamiento pasadas.                                         | Escenario 1: Historial detallado de reservas anteriores accesible desde la cuenta del usuario.                                                                         | EP01                      |
| US06          | Pagar por la Reserva                 | Como usuario, quiero pagar por mi reserva de estacionamiento a través de la aplicación para facilitar el proceso de pago.                                           | Escenario 1: Transacción completada con confirmación de pago enviada al usuario.                                                                                      | EP03                      |
| US07          | Recibir Factura Electrónica          | Como usuario, quiero recibir una factura electrónica después de realizar un pago para mantener un registro de mis transacciones.                                    | Escenario 1: Factura generada automáticamente y enviada al correo electrónico del usuario.                                                                            | EP03                      |
| US08          | Optimización de Ruta                 | Como usuario, quiero que la aplicación optimice mi ruta hacia el estacionamiento reservado para reducir el tiempo de viaje y evitar tráfico.                       | Escenario 1: Ruta optimizada generada basándose en datos de tráfico en tiempo real.                                                                                    | EP04                      |
| US09          | Validación de Pago Seguro            | Como usuario, quiero validar que mis datos de pago sean procesados de forma segura para evitar fraudes o pérdidas financieras.                                      | Escenario 1: Autenticación de seguridad exitosa durante el proceso de pago.                                                                                           | EP03                      |
| US10          | Acceso a Información de Seguridad    | Como usuario, quiero tener acceso a la información de seguridad del estacionamiento para asegurarme de que mi vehículo estará seguro.                               | Escenario 1: Información de seguridad visible en la página de detalles del estacionamiento.                                                                           | EP01                      |
| US11          | Integración con Sensores Infrarrojos | Como operador, quiero integrar sensores infrarrojos para automatizar la actualización de disponibilidad de espacios para una gestión eficiente del estacionamiento. | Escenario 1: Sensor infrarrojo detecta ocupación y actualiza la disponibilidad en tiempo real.                                                                         | EP05                      |
| US12          | Recibir Alertas de Seguridad         | Como usuario, quiero recibir alertas de seguridad relacionadas con el estacionamiento para proteger mi vehículo y mi integridad personal.                           | Escenario 1: Notificación de alerta enviada en caso de actividad sospechosa detectada en el estacionamiento.                                                           | EP02                      |
| US13          | Dejar una Reseña                     | Como usuario, quiero dejar una reseña sobre mi experiencia en el estacionamiento para ayudar a otros usuarios a tomar decisiones informadas.                        | Escenario 1: Reseña enviada y publicada en la página de detalles del estacionamiento.                                                                                 | EP06                      |
| US14          | Ver Reseñas de Otros Usuarios        | Como usuario, quiero ver las reseñas y calificaciones de otros usuarios sobre los estacionamientos para seleccionar el más adecuado.                                | Escenario 1: Reseñas de usuarios visibles en la página de detalles del estacionamiento.                                                                                | EP06                      |
| US15          | Acceso a Información de Tarifas      | Como usuario, quiero acceder a la información de tarifas de los estacionamientos para comparar precios y elegir la opción más económica.                            | Escenario 1: Información de tarifas disponible en la página de búsqueda de estacionamientos.                                                                           | EP01                      |
| US16          | Uso de Descuentos y Promociones      | Como usuario, quiero aplicar descuentos y promociones disponibles al realizar una reserva para ahorrar dinero en el estacionamiento.                                | Escenario 1: Descuento aplicado automáticamente al finalizar la reserva si cumple con los requisitos.                                                                 | EP01                      |
| US17          | Cambiar Método de Pago               | Como usuario, quiero poder cambiar mi método de pago guardado en la aplicación para gestionar mis preferencias de pago.                                             | Escenario 1: Cambio de método de pago realizado con éxito desde la configuración de la cuenta del usuario.                                                             | EP03                      |
| US18          | Interfaz Intuitiva                   | Como usuario, quiero que la aplicación tenga una interfaz intuitiva y fácil de usar para navegar y realizar mis operaciones de manera eficiente.                    | Escenario 1: Encuesta de satisfacción del usuario muestra una calificación alta en usabilidad y experiencia del usuario.                                                | EP01                      |
| US19          | Configurar Preferencias de Notificación | Como usuario, quiero configurar mis preferencias de notificación para recibir solo la información relevante sobre mis reservas y actividades de estacionamiento.    | Escenario 1: Configuración personalizada de notificaciones aplicada con éxito y reflejada en la cuenta del usuario.                                                     | EP02                      |
| US20          | Acceso a Soporte en Línea            | Como usuario, quiero tener acceso a soporte en línea en caso de problemas con la aplicación o mis reservas, para resolverlos rápidamente.                          | Escenario 1: Chat de soporte en línea disponible y funcional para resolver consultas de los usuarios en tiempo real.                                                   | EP01                      |
